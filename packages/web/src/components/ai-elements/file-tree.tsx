...
export const FileTreeActions = ({ className, children, ...props }: FileTreeActionsProps) => (
  // biome-ignore lint/a11y/useSemanticElements: upstream registry component — role="group" is the deliberate WAI-ARIA pattern for a tree-item action toolbar (a <fieldset> would impose unwanted fieldset semantics/reset behavior).
  <div
