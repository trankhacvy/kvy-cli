 ...
 */
export function buildSessionCasRoutes(db: Database, eventRouter: EventRouter): FastifyPluginAsyncZod {
  return async (app) => {
        ...
        async (req, reply) => {
          ...
          reply.raw.once("finish", () => {
            eventRouter.emitUpdate({
              recipientFilter: { type: "session-interested", accountId, sessionId: id },
              update: {
