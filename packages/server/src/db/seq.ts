 ...
 *
 * Also bumps `sessions.updatedAt`: this is the one write path every real
 * chat message goes through, so it's where "last touched" needs to become
 * true instead of only reflecting the four
