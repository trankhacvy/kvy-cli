...
export const schemaRegistry: Record<string, z.ZodTypeAny> = {
  ...
  GitInitParamsSchema: wire.GitInitParamsSchema,
  GitInitResultSchema: wire.GitInitResultSchema,
  GitSetRemoteParamsSchema: wire.GitSetRemoteParamsSchema,
  GitSetRemoteResultSchema: wire.GitSetRemoteResultSchema,
