...
export const REDUCED_CUSTODY =
  "kvy: this machine's stored keys can't unlock your sessions.\n" +
  "Connect it again from a device that has your keys.\n";

export const MACHINE_NOT_REGISTERED =
  "kvy: this machine hasn't finished connecting yet. Try again in a few seconds.\n";

export const NETWORK_UNREACHABLE =
  "kvy: couldn't reach the Kvy server. Check your connection and try again.\n";
